...
export default function FinalCTASection() {
  return (
    <section id="contact" className="px-6 py-24">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-red-500/20 bg-[#0D111A] p-8 text-center shadow-[0_0_80px_rgba(220,38,38,0.10)] md:p-14">
        ...
        <div className="relative z-10 mx-auto max-w-4xl">
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            <a
              ...
              className="rounded-full bg-red-600 px-8 py-4 text-sm font-bold text-white shadow-[0_0_30px_rgba(220,38,38,0.28)] transition hover:bg-red-500"
            >
            ...
            <a
              ...
              className="rounded-full border border-white/15 bg-white/[0.04] px-8 py-4 text-sm font-bold text-white transition hover:bg-white/10"
            >
