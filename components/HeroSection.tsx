...
export default function HeroSection() {
  return (
    <section className="relative mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center overflow-hidden px-5 pb-20 pt-36 text-center md:px-6 md:pb-24 md:pt-44">
      <div className="absolute inset-0 hidden bg-[linear-gradient(to_right,rgba(255,255,255,0.045)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.045)_1px,transparent_1px)] bg-[size:56px_56px] [mask-image:radial-gradient(circle_at_center,black,transparent_72%)] md:block" />
      ...
      <div className="relative z-10 mb-7 scale-90 md:scale-110">
        <OdyssixLogo />
      </div>

      <h1 className="relative z-10 max-w-5xl text-4xl font-black tracking-tight sm:text-5xl md:text-7xl">
        ODYSSIX Smart Sites
      </h1>

      <p className="relative z-10 mt-6 max-w-3xl text-xl font-semibold text-zinc-200 sm:text-2xl md:text-4xl">
